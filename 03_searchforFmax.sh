...
do
    ...
    cat templates/smd_Fmax.mdp | sed -e "s!#{FORCE_CONST}!${f_mid}!g" > pull_k${f_mid}.mdp

    echo "gmx grompp -f pull_${f_mid}.mdp -c npt_eq_${id}.gro -o pull -p topol.top -n index.ndx -maxwarn 1"
    echo "mdrun -v -deffnm pull -px pull_${f_mid}.xvg -pf pull_${f_mid}.xvg -ntmpi 1 -ntomp 20 >& pull_${f_mid}.job"
