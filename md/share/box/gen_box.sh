...
set -eu
## For isopropan
gmx editconf -f ../structure/organic/isopropane.acpype/smiles_molecule_GMX.gro -o box.gro -box 1.0 1.0 1.0
gmx genconf -f box.gro -nbox 10 -o isopropbox.gro -rot -seed 1122 
